...
const alamat = document.querySelector('#alamat'); // = alamatData
const alamatData = document.querySelector('#shippingAdress'); // change data-adress
...
fetch('./js/panel.json')
  ...
  .then((data) => {
    ...
    alamatData.setAttribute('data-adress', data.gift.alamat);
